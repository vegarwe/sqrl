...
add_custom_command(OUTPUT ${PROJECT_NAME}.dfu
    DEPENDS ${PROJECT_NAME}.bin
    COMMAND ${CMAKE_COMMAND} -E copy ${PROJECT_NAME}.bin ${PROJECT_NAME}.dfu
    COMMAND dfu-suffix -v 1209 -p 70b1 -a ${PROJECT_NAME}.dfu
)
...
add_custom_target(flash
    DEPENDS ${PROJECT_NAME}.dfu
    COMMAND dfu-util --reset --download ${PROJECT_NAME}.dfu
)
